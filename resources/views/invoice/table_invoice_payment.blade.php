                    ...
                    <div class="panel-body">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <span class="form-control">{{ $table->department }}</span>
                            </div>

                            <div class="form-group">
                                <label for="exampleInputEmail1">Total Name</label>
                                <span class="form-control">{{ $table->name }}</span>
                            </div>

                            <div class="form-group">
                                <label for="exampleInputEmail1">Total Table Amount</label>
                                <span class="form-control">{{ money($total_amount) }}</span>
                            </div>

                            <div class="form-group">
                                <label for="exampleInputEmail1">Today's Date</label>
                                <span class="form-control">{{ str_date(now()->toDateString()) }}</span>
                            </div>
