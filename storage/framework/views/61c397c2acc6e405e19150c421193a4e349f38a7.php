                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = $histories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($history->customer->firstname); ?> <?php echo e($history->customer->lastname); ?></td>
                                            <td><?php echo e($history->customer->phone_number); ?></td>
                                            ...
                                            <td>
                                                <?php if(userCanView('customer.delete_payment')): ?>
                                                    <a href="<?php echo e(route('customer.delete_payment',$history->id)); ?>" class="btn btn-danger btn-sm">Delete</a>
                                                <?php else: ?>
                                                    Action
                                                 <?php endif; ?>
                                            </td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/hotel/resources/views/customermanager/payment_report.blade.php ENDPATH**/ ?>