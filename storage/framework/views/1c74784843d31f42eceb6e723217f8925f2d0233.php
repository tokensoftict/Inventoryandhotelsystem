                                        ...
                                        <div class="col-md-6">
                                            <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    <h3 class="panel-title"><span class="<?php echo e($module->icon); ?>"></span>
                                                        <?php echo e($module->label); ?></h3>
                                                </div>
                                                <div class="panel-body" style="height: 150px; overflow: auto">
                                                    <div id="mCSB_4" class="" tabindex="0">
                                                        <div id="" class=""
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="checkbox">
                                                                                <label class="i-checks">
                                                                                    <input
                                                                                        <?php echo e(count($task->permissions) ? 'checked' : ''); ?>

                                                                                        name="privileges[<?php echo e($task->id); ?>]"
                                                                                        value="" type="checkbox">
                                                                                    <i></i>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yusufolatunji/MyProject/Web/Inventoryandhotelsystem/resources/views/access-control/permission-user-group.blade.php ENDPATH**/ ?>