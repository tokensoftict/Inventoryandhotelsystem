                        ...
                        <?php endif; ?>
                            ...
                            <table class="table table-bordered table-responsive table convert-data-table table-striped" style="font-size: 12px">
                                ...
                                <?php
                                    $total = 0;
                                ?>
                                <?php $__currentLoopData = $tableinvoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tableinvoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        $total += $tableinvoice->total_amount_paid;
                                    ?>
                                    <tr>
                                        <td><?php echo e($loop->iteration); ?></td>
                                        <td><?php echo e($tableinvoice->invoice_paper_number); ?></td>
                                        <td><?php echo e($tableinvoice->customer->firstname); ?> <?php echo e($tableinvoice->customer->lastname); ?></td>
                                        <td><?php echo invoice_status($tableinvoice->status); ?></td>
                                        <td><?php echo e(number_format($tableinvoice->sub_total,2)); ?></td>
                                        <td><?php echo e(number_format($tableinvoice->total_amount_paid,2)); ?></td>
                                        <td><?php echo e(convert_date2($tableinvoice->invoice_date)); ?></td>
                                        <td><?php echo e($tableinvoice->sales_time); ?></td>
                                        <td><?php echo e($tableinvoice->created_user->name); ?></td>
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul role="menu" class="dropdown-menu">
                                                    <?php if(userCanView('invoiceandsales.view')): ?>
                                                        <li><a href="<?php echo e(route('invoiceandsales.view',$tableinvoice->id)); ?>">View Invoice</a></li>
                                                    <?php endif; ?>
                                                        <?php if(userCanView('invoiceandsales.edit') && $tableinvoice->sub_total > -1 && $tableinvoice->status =="DRAFT"): ?>
                                                            <li><a href="<?php echo e(route('invoiceandsales.edit',$tableinvoice->id)); ?>">Edit Invoice</a></li>
                                                        <?php endif; ?>
                                                    <?php if(userCanView('invoiceandsales.pos_print')): ?>
                                                        <li><a onclick="open_print_window(this); return false" href="<?php echo e(route('invoiceandsales.pos_print',$tableinvoice->id)); ?>">Print Invoice Pos</a></li>
                                                    <?php endif; ?>
                                                    <?php if(userCanView('invoiceandsales.print_afour')): ?>
                                                        <li><a onclick="open_print_window(this); return false" href="<?php echo e(route('invoiceandsales.print_afour',$tableinvoice->id)); ?>">Print Invoice A4</a></li>
                                                    <?php endif; ?>
                                                    <?php if(userCanView('invoiceandsales.print_way_bill')): ?>
                                                        <li><a onclick="open_print_window(this); return false" href="<?php echo e(route('invoiceandsales.print_way_bill',$tableinvoice->id)); ?>">Print Waybill</a></li>
                                                    <?php endif; ?>
                                                </ul>
                                            </div>
                                        </td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TokenSoft\Inventoryandhotelsystem\resources\views/tableinvoice/draft-invoice.blade.php ENDPATH**/ ?>