                    ...
                    <header class="panel-heading">
                        ...
                        <form action=""  class="tools pull-right" style="margin-right: 80px" method="post">
                            ...
                            <div class="row">
                                <div class="col-sm-8">
                                    <label>Date</label>
                                    <input type="text" class="form-control datepicker js-datepicker" data-min-view="2" data-date-format="yyyy-mm-dd" style="background-color: #FFF; color: #000;"  value="<?php echo e($date); ?>" name="from" placeholder="From"/>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yusufolatunji/MyProject/Web/Inventoryandhotelsystem/resources/views/paymentreport/daily_payment_reports.blade.php ENDPATH**/ ?>